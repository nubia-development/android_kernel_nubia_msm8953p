...
static void nubia_do_key_down(struct work_struct *work)
{
	char *killer = NULL;
...
static void nubia_do_key_up(struct work_struct *work)
{
}
...
static int nubia_keyreset_probe(struct platform_device *pdev)
{
	int ret;
	int key, *keyp;
	struct keyreset_state *state;
	...
	INIT_DELAYED_WORK(&state->key_down_work, nubia_do_key_down);
	INIT_WORK(&state->key_up_work, nubia_do_key_up);
...
int nubia_keyreset_remove(struct platform_device *pdev)
{
...
struct platform_driver nubia_keyreset_driver = {
	.probe = nubia_keyreset_probe,
	.remove = nubia_keyreset_remove,
	.driver		= {
		.name	= "nubia_keyreset",
...
{
	return platform_driver_register(&nubia_keyreset_driver);
}

static void __exit keyreset_exit(void)
{
	return platform_driver_unregister(&nubia_keyreset_driver);
}
