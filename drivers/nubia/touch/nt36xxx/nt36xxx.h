...
#ifndef NUBIA_TOUCH_NVT
#define NUBIA_TOUCH_NVT 1

#include <linux/pinctrl/consumer.h>

#define NVT_PINCTRL_STATE_SUSPEND "nvt_pin_suspend"
#define NVT_PINCTRL_STATE_ACTIVE "nvt_pin_active"
#endif
...
#define NUBIA_TOUCH_PALM 1


#ifdef NUBIA_TOUCH_NVT
struct nubia_nvt_pinctrl {
...
struct nvt_ts_data {
	...
	uint16_t nvt_pid;
#ifdef NUBIA_TOUCH_NVT
	struct regulator *vreg_vddi;
	struct regulator *vreg_bus;
	struct nubia_nvt_pinctrl pinctrl_info;
#endif
	bool wakeup_gestrue_enable;
	bool palm_sleep_enable;
};
