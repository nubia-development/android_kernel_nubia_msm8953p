...
#endif
//read pcb type for other modules
...
//read pcb vesion for other modules
...
//read pcb version end



//part two :read rf version
...
//read config standard,eg:high version,low version
...
#else
    #define QFPROM_CPU_SERIAL_NUM_LSB  0x000A60A8
    #define QFPROM_CPU_SERIAL_NUM_MSB  0
#endif
